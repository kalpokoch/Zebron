...
const FAQItem = ({ question, answer, isOpen, onToggle }: FAQItemProps) => (
  <div className="w-full">
    {/* Question Container */}
    <div 
      className={`w-full h-auto min-h-[80px] md:h-[131px] rounded-[20px] md:rounded-[35px] border border-transparent bg-transparent flex items-center justify-between px-4 md:px-12 py-4 md:py-0 cursor-pointer transition-all duration-300 ${isOpen ? 'mb-6' : 'mb-0'}`}
      onClick={onToggle}
    >
      <h3 className="font-fahkwang text-[16px] md:text-[20px] font-bold text-black capitalize leading-normal text-left flex-1 pr-4">
        {question}
      </h3>
      
      {/* Arrow Button */}
      <div className="w-[50px] h-[50px] md:w-[72px] md:h-[72px] rounded-full border border-black flex items-center justify-center flex-shrink-0">
    ...
    {/* Answer Container */}
    {isOpen && answer && (
      <div className="px-4 md:px-12 pb-8 transition-all duration-300 ease-in-out">
        <p className="font-fahkwang text-[16px] md:text-[21px] font-bold text-black/70 capitalize leading-normal max-w-full md:max-w-[783px]">
          {answer}
        </p>
      </div>
    )}
    ...
    <section className="w-full py-16 lg:py-24 bg-white">
      <div className="mx-auto max-w-7xl px-4 lg:px-16">
        ...
        <div className="mb-12 lg:mb-16 text-center">
          <h2 className="font-fahkwang text-4xl md:text-6xl lg:text-[80px] font-bold leading-normal capitalize">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:ml-8">
            <div className="w-full aspect-[3/4] rounded-[20px] md:rounded-[30px] overflow-hidden">
              <img
